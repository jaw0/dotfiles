...
(let* (
       ...
       (comment-font   (if (boundp 'jaw-face-comment-font) (list :font jaw-face-comment-font) nil))
       (default-font   (if (boundp 'jaw-face-default-font) (list :font jaw-face-default-font) nil))
       ...
       (onmac     '((class color) (type ns mac) (min-colors 300)))
